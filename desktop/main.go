...
func main() {
	...
	PrevItem := NavSubMenu.AddText("Previous Diagram", keys.CmdOrCtrl("up"), func(_ *menu.CallbackData) {
		app.PrevPreview()
	})

	NextItem := NavSubMenu.AddText("Next Diagram", keys.CmdOrCtrl("down"), func(_ *menu.CallbackData) {
		app.NextPreview()
	})
